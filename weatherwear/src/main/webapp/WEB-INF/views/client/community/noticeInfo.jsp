				...
				<div style="width: 80%; margin: 0 auto;">
					<div class="card-header">
						...
						<div class="card-tools">
							등록일: <fmt:formatDate value="${info.noticeDate}" pattern="yyyy-MM-dd"/>&nbsp;&nbsp;
							조회수: ${info.noticeView}
						</div>
					</div>
					<div class="card-header">
					...
					<div class="card-footer float-right mg-2">
						<button type="button" class="btn btn-flat btn-outline-dark" onclick="history.go(-1);location.href = document.referrer;"><i class="fas fa-bars"></i>&nbsp;&nbsp;목록</button>
					</div>
				</div>
			</section>
		</main>
