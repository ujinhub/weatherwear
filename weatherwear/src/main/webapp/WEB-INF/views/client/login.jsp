						...
						<div class="col-lg-12 text-center mb-5">
							<div style="width: 35%; display: inline-block;">
								...
								<div class="text-center mg-2">
									<a href="#" class="btnNaver"></a>
									<a href="#" class="btnKakao"></a>
									<a href="#" class="btnGoogle"></a>
								</div>
								 -->
								 
								<div>
									<button type="button" class="btn btn-block btn-secondary pd-1 mg-2" onclick="location.href='noClientOrder.do'"><i class="fas fa-shopping-cart"></i>&nbsp;&nbsp;비회원 주문조회</button>
								</div>
							</div>
						</div>
					</div>
