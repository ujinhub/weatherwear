					...
					<div class="row">
						...
						<div class="col-lg-12 text-center mb-5">
							<div style="width: 35%; display: inline-block;">
								<form action="noClientOrderProc.do" method="post" id="unKnownUser">
									<input type="text" class="form-control form-control-border border-width-2 mg-2" name="name" placeholder="주문자명">
									<input type="text" class="form-control form-control-border border-width-2 mg-2" name="num" placeholder="주문번호">
									<input type="password" class="form-control form-control-border border-width-2 mg-2" name="pwd" placeholder="비회원주문 비밀번호">
