							...
							<div class="card">
								<div class="card-header">
									<div class="card-title">
										<button type="button" class="btn btn-sm btn-outline-primary" onclick="location.href='noticeRegister.mdo'">+등록</button>
									</div>
									...
									<table class="table table-hover text-nowrap" style="table-layout: fixed;">
										...
										<tbody>
											<c:forEach var="item" items="${noticeList}" varStatus="status">
												...
												<tr onclick="location.href='noticeInfo.mdo?noticeId=${item.noticeId}'">
